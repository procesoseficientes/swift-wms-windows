...
Public Class myPicking
    ...
    Public Sub New()
        ...
        TipoVisualizacion.SelectedIndex = 0
    End Sub
    ...
    Private Sub AdvancedTree1_ButtonClick(ByVal sender As Object, ByVal e As Resco.Controls.AdvancedTree.CellEventArgs) Handles AdvancedTree1.ButtonClick
        ...
        Try
            ...
            Select Case TipoVisualizacion.Items.SelectedItem.Index
                ...
                Case CInt(MobilityScm.Modelo.Tipos.TipoVisualizacionTareasPicking.PorUbicacion)
                    gCurrentCodigoPolizaSource = e.Cell(e.Node, 4).ToString
            End Select
            ...
            Else
                ...
                result = infoTransService.ValidateTaskStatus(GlobalUserID, 0, 0, pWaveID, pMaterialId, "TAREA_PICKING", GlobalEnviroment, pResult)
    ...
    Private Sub AdvancedTree1_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles AdvancedTree1.KeyUp, TipoVisualizacion.KeyUp
        ProcessLastKey(e)
    End Sub
        ...
        Try
            Select Case e.ObtenerActionDeBoton(GlobalEnviroment, Global_WS_HOST)
                ...
                Case MobilityScm.Modelo.Tipos.FuncionBoton.GUARDAR
                    ''refresh tree
                    Cursor.Current = Cursors.WaitCursor
                    AdvancedTree1.LoadXml(GetXmlPathByPickingVisualizationType(TipoVisualizacion.Items.SelectedItem.Index))
                    'ShowPanel(panelMyPicking)
                    'LoadPage("my_waves_tree", gPanelTitle, False)
                    Cursor.Current = Cursors.Default
            End Select
    ...
    Private Sub TipoVisualizacion_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TipoVisualizacion.SelectedValueChanged
        If Not gCurrentTransactionType = gTRANS_TYPE.NONE Then
            Cursor.Current = Cursors.WaitCursor
            AdvancedTree1.LoadXml(GetXmlPathByPickingVisualizationType(TipoVisualizacion.Items.SelectedItem.Index))
            Cursor.Current = Cursors.Default
        End If
