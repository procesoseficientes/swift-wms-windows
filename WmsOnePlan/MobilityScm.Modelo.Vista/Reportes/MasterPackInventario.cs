...
{
    public partial class MasterPackInventario : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void MasterPackInventario_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
