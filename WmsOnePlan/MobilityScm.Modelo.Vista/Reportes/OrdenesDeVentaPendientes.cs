...
{
    public partial class OrdenesDeVentaPendientes : DevExpress.XtraReports.UI.XtraReport
    {
        public OrdenesDeVentaPendientes()
        {
            InitializeComponent();
        }

        private void OrdenesDeVentaPendientes_DataSourceDemanded(object sender, EventArgs e)
        {
