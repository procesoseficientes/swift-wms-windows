...
{
    public partial class ConsultaPedidosPorVendedor : DevExpress.XtraReports.UI.XtraReport
    {
        public ConsultaPedidosPorVendedor()
        {
            InitializeComponent();
        }

        private void ConsultaPedidosPorVendedor_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
