...
{
    public partial class AcuerdoComercialPorInventario : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void AcuerdoComercialPorInventario_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
