...
{
    public partial class ConsultaCosteosPorDocumento : DevExpress.XtraReports.UI.XtraReport
    {
        public ConsultaCosteosPorDocumento()
        {
            InitializeComponent();
        }

        private void ConsultaCosteosPorDocumento_DataSourceDemanded(object sender, EventArgs e)
        {
