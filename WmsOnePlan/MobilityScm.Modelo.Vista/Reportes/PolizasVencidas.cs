...
{
    public partial class PolizasVencidas : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void PolizasVencidas_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
