...
{
    public partial class ConsultaConteoFiciso : DevExpress.XtraReports.UI.XtraReport
    {
        public ConsultaConteoFiciso()
        {
            InitializeComponent();
        }

        private void ConsultaConteoFiciso_DataSourceDemanded(object sender, EventArgs e)
        {
