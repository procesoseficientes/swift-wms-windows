...
{
    public partial class SolicitudDeTraslado : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void SolicitudDeTraslado_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
                var logo = LOGO.Value.ToString();
