...
{
    public partial class ConsultaCosteosConsolidado : DevExpress.XtraReports.UI.XtraReport
    {
        public ConsultaCosteosConsolidado()
        {
            InitializeComponent();
        }

        private void ConsultaCosteosConsolidado_DataSourceDemanded(object sender, EventArgs e)
        {
