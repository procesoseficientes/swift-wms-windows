...
{
    public partial class ReporteDevolucionesConsolidado : DevExpress.XtraReports.UI.XtraReport
    {
        public ReporteDevolucionesConsolidado()
        {
            InitializeComponent();
        }

        private void ReporteDevolucionesConsolidado_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
