...
{
    public partial class ReporteDevolucionesDetallado : DevExpress.XtraReports.UI.XtraReport
    {
        public ReporteDevolucionesDetallado()
        {
            InitializeComponent();
        }

        private void ReporteDevolucionesDetallado_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
