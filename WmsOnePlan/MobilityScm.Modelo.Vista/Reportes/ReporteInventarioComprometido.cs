...
{
    public partial class ReporteInventarioComprometido : DevExpress.XtraReports.UI.XtraReport
    {
        public ReporteInventarioComprometido()
        {
            InitializeComponent();
        }

        private void ReporteInventarioComprometido_DataSourceDemanded(object sender, EventArgs e)
        {
            try
            {
