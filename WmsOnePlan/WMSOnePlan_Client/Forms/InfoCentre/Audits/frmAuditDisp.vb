Public Class frmAuditDisp 
        ...
        Try
            ...
            If pResult = "OK" Then
                ...
                GridView1.OptionsDetail.ShowDetailTabs = False
                 ...
                 LoadGridLayout("INFO_UDIT_DISP_FISCAL", PublicLoginInfo.LoginID, Me.GridControl1.MainView)
            Else
    ...
    Private Sub frmAuditDisp_Leave(sender As Object, e As System.EventArgs) Handles Me.Leave
        gLastScreenShowed = Me.Name
                SaveGridLayout("INFO_UDIT_DISP_FISCAL", PublicLoginInfo.LoginID, Me.GridView1)
