...
Public Class rptInventoryOnline
    Private Sub rptInventoryOnline_DataSourceDemanded(sender As Object, e As EventArgs) Handles MyBase.DataSourceDemanded
        Try
        ...
        End Try
    End Sub
    'Private Sub rptInventoryOnline_Load(ByVal sender As Object, ByVal e As System.EventArgs) 'Handles Me.DesignerLoaded
    '   XrPageInfo4.Text= PublicLoginInfo.LoginName.ToString()
    '   MessageBox.Show("Usuario: "+PublicLoginInfo.LoginName)
    'End Sub
End Class