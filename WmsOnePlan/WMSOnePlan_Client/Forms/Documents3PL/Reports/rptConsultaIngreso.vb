...
Public Class rptConsultaIngreso
    Private Sub rptConsultaIngreso_DataSourceDemanded(sender As Object, e As EventArgs) Handles MyBase.DataSourceDemanded
    ...
    Private Sub XrLabel17_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles XrLabel17.BeforePrint
        xrLabel17.Text = DateTime.Parse(xrLabel17.Text).ToString("dd/MM/yyyy")
    End Sub

    Private Sub XrLabel20_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles XrLabel20.BeforePrint
        
        xrLabel20.Text = Decimal.Parse(IIf(string.IsNullOrEmpty(xrLabel20.Text), "0", xrLabel20.Text)).ToString("###,###,##0.00")
    End Sub

    Private Sub XrLabel26_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles XrLabel26.BeforePrint
        
        xrLabel26.Text = Decimal.Parse(IIf(string.IsNullOrEmpty(xrLabel26.Text), "0", xrLabel26.Text)).ToString("###,###,##0.00")
    End Sub

    Private Sub XrLabel25_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles XrLabel25.BeforePrint
        
        xrLabel25.Text = Decimal.Parse(IIf(string.IsNullOrEmpty(xrLabel25.Text), "0", xrLabel25.Text)).ToString("###,###,##0.00")
    End Sub
End Class