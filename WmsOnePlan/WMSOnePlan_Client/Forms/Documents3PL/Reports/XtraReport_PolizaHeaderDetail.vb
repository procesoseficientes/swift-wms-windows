...
Public Class XtraReport_PolizaHeaderDetail
    Public Sub New()
    ...
    Private Sub XtraReport_PolizaHeaderDetail_DataSourceDemanded(sender As Object, e As EventArgs) Handles MyBase.DataSourceDemanded
        Try
