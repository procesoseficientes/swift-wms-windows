...
Public Class rptPaseSalida
    ...
    Private Sub rptPaseSalida_DataSourceDemanded(sender As Object, e As EventArgs) Handles MyBase.DataSourceDemanded
        Try
            Dim servicioConfiguracion As New OnePlanServices_Settings.WMS_SettingsSoapClient("WMS_SettingsSoap", PublicLoginInfo.WSHost + "/Catalogues/wms_settings.asmx")
            Dim xdataset As New DataSet
            Dim pResult As String = ""
            xdataset = servicioConfiguracion.GetParam_ByParamKey("SISTEMA", "MOSTRAR_LOGO_REPORTE", "", pResult, PublicLoginInfo.Environment)

            If pResult = "OK" Then
                If xdataset.Tables(0).Rows.Cast(Of Object)().Any(Function(xdr) xdr("PARAM_NAME").ToString.ToUpper().Equals("PASE_DE_SALIDA") And xdr("TEXT_VALUE").ToString.ToUpper().Equals("NO")) Then
                    Return
                End If
            End If
