...
Public Class frmPaseSalida
    ...
    Private Sub BarLargeButtonItem1_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarLargeButtonItem1.ItemClick
        Try
            ...
            If pResult = "OK" Then
                ...
                rptPaseSalida.Parameters("logoImg").Value = PublicLoginInfo.LOGO 
    ...
    End Sub
    Private Sub btnPassid_Properties_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPassid.Properties.Click
        ShowPassDetail(Val(btnPassid.EditValue))
    End Sub
    ...
    Private Sub LlenarGrid()
        Try
            pResult = ""
            dsPolPass = xInfoTrans.GetAuditView(Val(btnPassid.EditValue), "MMI_AUDIT_DISPATCH_FISCAL_DETAIL", pResult, PublicLoginInfo.Environment)
            If pResult = "OK" Then
