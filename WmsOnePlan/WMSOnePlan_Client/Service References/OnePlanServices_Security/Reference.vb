...
Namespace OnePlanServices_Security
    ...
    Public Interface WMS_SecuritySoap
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/UpdateLicense", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function UpdateLicense(ByVal pPRIV_LOGIN_ID As String, ByVal pPRIV_LICENSE As String, ByRef pResult As String, ByVal pEnvironmentName As String) As Boolean
    ...
    Partial Public Class WMS_SecuritySoapClient
        ...
        Public Function UpdateLicense(ByVal pPRIV_LOGIN_ID As String, ByVal pPRIV_LICENSE As String, ByRef pResult As String, ByVal pEnvironmentName As String) As Boolean Implements OnePlanServices_Security.WMS_SecuritySoap.UpdateLicense
            Return MyBase.Channel.UpdateLicense(pPRIV_LOGIN_ID, pPRIV_LICENSE, pResult, pEnvironmentName)
        End Function
